...
import com.example.demo.repository.FileUtil;
...
public class FileService {
    ...
    public void saveFile1(File file) {
    ...
    public void saveFile2(String filePath) {
        try {
            // 파일 데이터를 읽어옵니다.
...
//            FileEntity fileEntity = new FileEntity();
            fileDTO.setFileName(FileUtil.getFileName(filePath));
            fileDTO.setFileType(FileUtil.getFileExtension(filePath));
